...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Vehicle Addition.create': { roles: ['administrator'], key: 'vehicle_addition', tenantPath: [], userPath: [] },
  'Vehicle Update.update': { roles: ['administrator'], key: 'vehicle_update', tenantPath: [], userPath: [] },
  'Vehicle Removal.delete': { roles: ['vehicle-manager'], key: 'vehicle_removal', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['administrator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['administrator', 'vehicle-manager'];
