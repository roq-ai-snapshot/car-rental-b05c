...
import { getVehicleManagers } from 'apiSdk/vehicle-managers';
...
function VehicleCreatePage() {
  ...
  const formik = useFormik<VehicleInterface>({
    initialValues: {
      ...
      vehicle_manager_id: (router.query.vehicle_manager_id as string) ?? null,
    },
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<VehicleManagerInterface>
            formik={formik}
            name={'vehicle_manager_id'}
            label={'Select Vehicle Manager'}
            placeholder={'Select Vehicle Manager'}
            fetcher={getVehicleManagers}
            labelField={'name'}
          />
