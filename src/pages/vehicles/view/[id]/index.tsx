          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="License Plate Number" text={data?.license_plate_number} />
                ...
                {hasAccess('vehicle_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/vehicle-managers/view/${data?.vehicle_manager?.id}`}>
                        {data?.vehicle_manager?.name}
                      </Link>
                    }
                  />
                )}
