  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Rental - Streamlining your carsharing experience. Manage profiles, add vehicle information, and view all data centrally. Drive into efficiency with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Rental - Streamlining your carsharing experience. Manage profiles, add vehicle information, and view all data centrally. Drive into efficiency with us.`}
            </Text>
            <Box
